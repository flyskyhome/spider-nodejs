 ...
 * @type {Object}
 */
function jjckbList(dataStore){
	this.dataStore=dataStore;
}

jjckbList.prototype=new genList(jjckbList.dataStore);
	 ...
	 */
	jjckbList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	jjckbList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "jjckb");
		this.init(urlCount,urlList, "info");
		this.getInfo(sKey, "gbk");
	};

var jjckbList_Obj=new jjckbList({
										sn:0,
