 ...
 * @type {Object}
 */
function cnforexList(dataStore){
	this.dataStore=dataStore;
}

cnforexList.prototype=new genList(cnforexList.dataStore);
	 ...
	 */
	cnforexList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	cnforexList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "cnforex");
		this.init(urlCount,urlList, "info");
		this.getInfo(sKey, "gbk");
	};

var cnforexList_Obj=new cnforexList({
										sn:0,
...
module.exports = cnforexList_Obj;