 ...
 * @type {Object}
 */
function p5wList(dataStore){
	this.dataStore=dataStore;
}

p5wList.prototype=new genList(p5wList.dataStore);
	 ...
	 */
	p5wList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	p5wList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "p5w");
		this.init(urlCount,urlList, "info");
		this.getInfo(sKey, "gbk");
	};

var p5wList_Obj=new p5wList({
										sn:0,
										...
										parseRuleList:[{
											main:".sto-left-list h2 a"
										}]
									});

module.exports = p5wList_Obj;