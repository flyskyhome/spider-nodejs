 ...
 * @type {Object}
 */
function wsjcnList(dataStore){
	this.dataStore=dataStore;
}

wsjcnList.prototype=new genList(wsjcnList.dataStore);
	 ...
	 */
	wsjcnList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	wsjcnList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "wsjcn");
		this.init(urlCount,urlList, "info");
		this.getInfo(sKey, "utf-8");
	};

var wsjcnList_Obj=new wsjcnList({
										sn:0,
