 ...
 * @type {Object}
 */
function caijingList(dataStore){
	this.dataStore=dataStore;
}

caijingList.prototype=new genList(caijingList.dataStore);
	 ...
	 */
	caijingList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	caijingList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "caijing");
		this.init(urlCount,urlList, "info");
		this.getInfo(sKey, "utf-8");
	};

var caijingList_Obj=new caijingList({
										sn:0,
...
module.exports = caijingList_Obj;