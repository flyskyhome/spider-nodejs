 ...
 * @type {Object}
 */
function fx678_zhiboList(dataStore){
	this.dataStore=dataStore;
}

fx678_zhiboList.prototype=new genList(fx678_zhiboList.dataStore);
	 ...
	 */
	fx678_zhiboList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	fx678_zhiboList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
...
var fx678_zhiboList_Obj=new fx678_zhiboList({
										sn:0,
...
module.exports = fx678_zhiboList_Obj;