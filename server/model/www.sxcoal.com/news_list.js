 ...
 * @type {Object}
 */
function sxcoalList(dataStore){
	this.dataStore=dataStore;
}

sxcoalList.prototype=new genList(sxcoalList.dataStore);
	 ...
	 */
	sxcoalList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	sxcoalList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "sxcoal");
		this.init(urlCount,urlList, "info");
		this.getInfo(sKey, "gbk");
	};

var sxcoalList_Obj=new sxcoalList({
										sn:0,
										...
										parseRuleList:[{
											main:".rightarea_1 .li2 a"
										}]
									});

module.exports = sxcoalList_Obj;