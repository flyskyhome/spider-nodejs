 ...
 * @type {Object}
 */
function nbdList(dataStore){
	this.dataStore=dataStore;
}

nbdList.prototype=new genList(nbdList.dataStore);
	 ...
	 */
	nbdList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	nbdList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "nbd");
		this.init(urlCount,urlList, "info");
		this.getInfo(sKey, "utf-8");
	};

var nbdList_Obj=new nbdList({
										sn:0,
