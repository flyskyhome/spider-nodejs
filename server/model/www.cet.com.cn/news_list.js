 ...
 * @type {Object}
 */
function cetList(dataStore){
	this.dataStore=dataStore;
}

cetList.prototype=new genList(cetList.dataStore);
	 ...
	 */
	cetList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	cetList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "cet");
		this.init(urlCount,urlList, "info");
		this.getInfo(sKey, "gbk");
	};

var cetList_Obj=new cetList({
										sn:0,
										...
										parseRuleList:[{
											main:".mag_01 .font_05 a"
										}]
									});

module.exports = cetList_Obj;