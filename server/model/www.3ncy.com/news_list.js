 ...
 * @type {Object}
 */
function a3ncy_List(dataStore){
	this.dataStore=dataStore;
}

a3ncy_List.prototype=new genList(a3ncy_List.dataStore);
	 ...
	 */
	a3ncy_List.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	a3ncy_List.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "a3ncy_");
		this.init(urlCount,urlList, "info");
		this.getInfo(sKey, "utf-8");
	};

var a3ncy_List_Obj=new a3ncy_List({
										sn:0,
