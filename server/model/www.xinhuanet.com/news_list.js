 ...
 * @type {Object}
 */
function xinhuanetList(dataStore){
	this.dataStore=dataStore;
}

xinhuanetList.prototype=new genList(xinhuanetList.dataStore);
	 ...
	 */
	xinhuanetList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	xinhuanetList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "ce");
		this.init(urlCount,urlList, "info");
		this.getInfo(sKey, "utf-8");
	};

var xinhuanetList_Obj=new xinhuanetList({
										sn:0,
...
module.exports = xinhuanetList_Obj;