 ...
 * @type {Object}
 */
function stcnList(dataStore){
	this.dataStore=dataStore;
}

stcnList.prototype=new genList(stcnList.dataStore);
	 ...
	 */
	stcnList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	stcnList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "stcn");
		this.init(urlCount,urlList, "info");
		this.getInfo(sKey, "utf-8");
	};

var stcnList_Obj=new stcnList({
										sn:0,
