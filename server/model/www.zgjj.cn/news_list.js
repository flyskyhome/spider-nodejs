 ...
 * @type {Object}
 */
 function zgjjList(dataStore){
	this.dataStore=dataStore;
}

zgjjList.prototype=new genList(zgjjList.dataStore);
	 ...
	 */
	zgjjList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	zgjjList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "zgjj");
		this.init(urlCount,urlList, "info");
		this.getInfo(sKey, "gbk");
	};

var zgjjList_Obj=new zgjjList({
										sn:0,
