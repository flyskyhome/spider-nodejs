 ...
 * @type {Object}
 */
function smmList(dataStore){
	this.dataStore=dataStore;
}

smmList.prototype=new genList(smmList.dataStore);
	 ...
	 */
	smmList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	smmList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "smm");
		this.init(urlCount,urlList, "info");
		this.getInfo(sKey, "utf-8");
	};

var smmList_Obj=new smmList({
										sn:0,
