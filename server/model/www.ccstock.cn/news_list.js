 ...
 * @type {Object}
 */
function ccstockList(dataStore){
	this.dataStore=dataStore;
}

ccstockList.prototype=new genList(ccstockList.dataStore);
	 ...
	 */
	ccstockList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	ccstockList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "ccstock");
		this.init(urlCount,urlList, "info");
		this.getInfo(sKey, "utf-8");
	};

var ccstockList_Obj=new ccstockList({
										sn:0,
...
module.exports = ccstockList_Obj;