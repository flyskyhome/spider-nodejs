 ...
 * @type {Object}
 */
function reuters_CNList(dataStore){
	this.dataStore=dataStore;
}

reuters_CNList.prototype=new genList(reuters_CNList.dataStore);
 ...
 */
reuters_CNList.prototype.getPageUrlList=function(urlList,sCharSet) {
...
reuters_CNList.prototype.exec=function(urlList, sKey,urlCount) {
	console.log(sKey);
	console.log(urlList);
...
var reuters_CNList_Obj=new reuters_CNList({
										sn:0,
...
module.exports = reuters_CNList_Obj;