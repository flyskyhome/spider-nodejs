 ...
 * @type {Object}
 */
function ceList(dataStore){
	this.dataStore=dataStore;
}

ceList.prototype=new genList(ceList.dataStore);
	 ...
	 */
	ceList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	ceList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
...
var ceList_Obj=new ceList({
										...
										parseRuleList:[{
											main:".lb .font14_lan a"
										}]
									});

module.exports = ceList_Obj;