...
(function ($) {
    ...
    function _1ad(_1ae) {
        ...
        if (_1af.options.modal == true) {
            ...
            _1af.mask.css({ width: (_1af.options.inline ? _1af.mask.parent().width() - 1 : _1b2().width - 1), height: (_1af.options.inline ? _1af.mask.parent().height() - 1 : _1b2().height - 1), display: "none" });
        }
        if (_1af.shadow) {
            _1af.shadow.remove();
        }
