...
function hexunList(dataStore){
	this.dataStore=dataStore;
}

hexunList.prototype=new genList(hexunList.dataStore);
	 ...
	 */
	hexunList.prototype.getPageUrlList= function(urlList,sCharSet) {
	...
	hexunList.prototype.exec= function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "hexun");
		this.init(urlCount,urlList, "info");
		this.getInfo(sKey, "gbk");
	};

var hexunList_Obj=new hexunList({
										sn:0,
										...
										parseRuleList:[{
											main:".mainboxcontent .temp01 a"
										}]
									});


module.exports = hexunList_Obj;