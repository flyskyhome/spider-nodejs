 ...
 * @type {Object}
 */
function jrjFinanceList(dataStore){
	this.dataStore=dataStore;
}

jrjFinanceList.prototype=new genList(jrjFinanceList.dataStore);
	 ...
	 */
	jrjFinanceList.prototype.getPageUrlList=function(urlList,sCharSet) {
	...
	jrjFinanceList.prototype.exec=function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
...
var jrjFinanceList_Obj=new jrjFinanceList({
										sn:0,
...
module.exports = jrjFinanceList_Obj;