 ...
 * @type {Object}
 */
function glinfoList(dataStore){
	this.dataStore=dataStore;
}

glinfoList.prototype=new genList(glinfoList.dataStore);
	 ...
	 */
	glinfoList.prototype.getPageUrlList=function(urlList,sCharSet) {
	...
	glinfoList.prototype.exec=function(urlList, sKey,urlCount) {
		console.log(sKey);
		console.log(urlList);
//		this.init(urlList, "glinfo");
...
var glinfoList_Obj=new glinfoList({
										sn:0,
